                    ...
                    if (!tab) {
                        ...
                        for (int j = 0; j < templates[i - 1].size(); j++) {
                            if (templates[i - 1][j].rfind(labels[i], 0) == 0) {
                                ...
                                std::cout << templates[i - 1][j].substr(labels[i].size(), templates[i - 1][j].size());
                                index += templates[i - 1][j].substr(labels[i].size(), templates[i - 1][j].size()).size() + labels[i].size() - (index - sizesref[i][0]);
...
void bcin(std::string& output, std::string prefix, std::vector<std::string> templates) {
    char ch = ' ';
                ...
                if (i > 0 && (index >= sizesref[i][0] && index <= sizesref[i][1])) {
                    if (!tab) {
                        ...
                        for (int j = 0; j < templates.size(); j++) {
                            if (templates[j].rfind(labels[i], 0) == 0) {
                                std::cout << templates[j].substr(labels[i].size(), templates[j].size());
                                break;
                            }
                        }
                        SetConsoleTextAttribute(h, 15);
                        ...
                        for (int j = 0; j < templates.size(); j++) {
                            if (templates[j].rfind(labels[i], 0) == 0) {
                                input.insert(sizesref[i][1], templates[j].substr(labels[i].size(), templates[j].size()));
                                std::cout << templates[j].substr(labels[i].size(), templates[j].size());
                                index += templates[j].substr(labels[i].size(), templates[j].size()).size() + labels[i].size() - (index - sizesref[i][0]);
                                maxX += templates[j].substr(labels[i].size(), templates[j].size()).size();
                                tab = false;
                                break;
                            }
                        }
